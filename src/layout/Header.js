            ...
            <Container>
                ...
                <NavbarMenu isActive={mobileMenuOpen} onClick={toggleMobileMenu}>
                    <NavbarEnd>
                        ...
                        <NavbarItem href="https://www.amazon.com/Franz-Diebold-mythology-land/dp/B07QRGT3Q8" target="_blank" className="has-tooltip-bottom" data-tooltip="'Alexa, open mythology land'">{alexaIcon}</NavbarItem>
